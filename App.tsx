  ...
  return (
    <div className="min-h-screen font-sans selection:bg-regal-gold selection:text-white">
      ...
      <button 
        ...
        className={`fixed bottom-8 right-8 z-[100] p-4 bg-white border border-regal-gold/30 rounded-full shadow-2xl transition-all duration-500 hover:scale-110 active:scale-95 group ${
