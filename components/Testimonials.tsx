...
const testimonials = [
    {
        ...
        quote: "KGN MARBLE HOUSE transformed our flagship residential project. Their Calacatta slabs are unparalleled in purity and veining. A truly flawless experience.",
