    ...
    switch (type) {
      ...
      case 'archive':
        const archiveMarbles = [
          { name: "Michelangelo Statuario", grade: "Grade A+", img: "https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?auto=format&fit=crop&q=80&w=800" },
          { name: "Royal Portoro Gold", grade: "Limited", img: "https://images.unsplash.com/photo-1523821741446-edb2b68bb7a0?auto=format&fit=crop&q=80&w=800" },
          { name: "Calacatta Viola", grade: "Grade A", img: "https://images.unsplash.com/photo-1604147706323-5039973c810d?auto=format&fit=crop&q=80&w=800" },
          { name: "Verde Alpi", grade: "Premium", img: "https://images.unsplash.com/photo-1599394022918-6c276a5b09bb?auto=format&fit=crop&q=80&w=800" }
        ];
        return (
          <div className="fade-in">
