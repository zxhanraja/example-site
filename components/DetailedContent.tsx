  ...
  const renderContent = () => {
    switch (type) {
      ...
      case 'heritage':
        return (
          <div className="fade-in">
            <h1 className="text-4xl md:text-7xl font-serif italic text-charcoal mb-12">The CHOWDHURY MARBLE Dynasty</h1>
            <div className="space-y-12 text-charcoal/70 font-light leading-loose text-base md:text-lg max-w-4xl">
              ...
              <section>
                ...
                <p>Born in the quarries of Carrara, CHOWDHURY MARBLE was established to unite ancient geological mastery with modern architectural vision. Our foundation is built on decades of trust with heritage quarry owners.</p>
              </section>
              <section>
          ...
          <div className="fade-in">
            ...
            <div className="space-y-8 text-charcoal/70 font-light leading-relaxed text-sm md:text-base max-w-3xl">
              ...
              <section>
                ...
                <p>All CHOWDHURY MARBLE showrooms are fully wheelchair accessible with personal concierge assistance available on-site.</p>
              </section>
            </div>
          </div>
        );
