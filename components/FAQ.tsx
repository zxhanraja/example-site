...
const faqs = [
    {
        ...
        answer: "Yes, J S Tiles Emporium coordinates secure, international shipping for our curated slabs directly to your project site, ensuring the material arrives in pristine condition."
    },
    {
