...
const faqs = [
    {
        ...
        answer: "Yes, Amazon Marble Centre coordinates secure, international shipping for our curated slabs directly to your project site, ensuring the material arrives in pristine condition."
    },
    {
