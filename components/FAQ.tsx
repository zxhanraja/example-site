...
const faqs = [
    {
        ...
        answer: "Yes, KGN MARBLE HOUSE coordinates secure, international shipping for our curated slabs directly to your project site, ensuring the material arrives in pristine condition."
    },
    {
