    ...
    <div className="relative h-[90vh] md:h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl pt-20">
        <div className="inline-block mb-6 md:mb-10 py-1.5 px-4 border border-champagne/40 rounded-full fade-in" style={{ animationDelay: '0.1s' }}>
          <span className="text-[8px] md:text-[10px] uppercase tracking-[0.5em] text-champagne font-bold">
            Exclusive Natural Stone Mastery
          </span>
        </div>
        
        <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-serif text-white mb-6 md:mb-10 leading-[1] italic fade-in" style={{ animationDelay: '0.3s' }}>
          Majestic <br />
          <span className="not-italic text-gold-gradient block mt-2">Elegance</span>
        </h1>
        
        <p className="text-xs md:text-xl lg:text-2xl text-white/70 max-w-2xl mx-auto font-light mb-10 md:mb-14 leading-relaxed fade-in px-4" style={{ animationDelay: '0.5s' }}>
