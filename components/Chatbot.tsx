...
const Chatbot: React.FC = () => {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { role: 'model', text: 'Welcome to J S Tiles Emporium. How may I assist you with our luxury stone and sanitary collections today?' }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const systemInstruction = {
                role: "user",
                parts: [{
                    text: "You are an elite, highly professional concierge for 'J S Tiles Emporium', a luxury natural stone, marble, bath fitting, and sanitary brand based at 489, Grand Trunk Rd, Mahesh, Serampore, Kolkata, West Bengal 712202. Direct contact: 07004745766. You provide instant, polite, and extremely concise replies. You assist architects, designers, and distinguished clients with inquiries about premium marble, tiles, bath fittings, and sanitary wares. Never break character. Be exceptionally courteous."
                }]
            };
        ...
        <>
            ...
            >
                ...
                <div className="bg-charcoal text-white p-5 rounded-t-sm flex items-center justify-between border-b border-regal-gold/20">
                    <div>
                        <h3 className="font-serif italic text-lg text-regal-gold">J S Tiles Emporium Concierge</h3>
