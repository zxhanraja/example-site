...
const Chatbot: React.FC = () => {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { role: 'model', text: 'Welcome to KGN MARBLE HOUSE. How may I assist you with our luxury stone collections today?' }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const systemInstruction = {
                role: "user",
                parts: [{
                    text: "You are an elite, highly professional concierge for 'KGN MARBLE HOUSE', a luxury natural stone and marble brand based at Pursura - Chatrasal Rd, Pursura, West Bengal 712401. Direct contact: 09735142667. You provide instant, polite, and extremely concise replies. You assist architects, designers, and distinguished clients with inquiries about premium marble, tiles, and bespoke sourcing. Never break character. Be exceptionally courteous."
                }]
            };
            ...
            setMessages((prev) => [...prev, { role: 'model', text: 'I apologize, but I am currently unable to process your request. Please call us directly at 09735142667.' }]);
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <>
            ...
            >
                ...
                <div className="bg-charcoal text-white p-5 rounded-t-sm flex items-center justify-between border-b border-regal-gold/20">
                    <div>
                        <h3 className="font-serif italic text-lg text-regal-gold">KGN MARBLE HOUSE Concierge</h3>
